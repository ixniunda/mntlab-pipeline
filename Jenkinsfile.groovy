node {
   // notifyStarted()
    ...
    stage('Packaging and Publishing results') {
        ...
        sh "curl -v --user 'admin:admin123' --upload-file ${artifact_name} http://10.6.154.84:8081/repository/maven-prod/pipeline/pipeline-${branch_name}/${BUILD_NUMBER}/${artifact_name}"
